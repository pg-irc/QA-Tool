...
import { aString, anInteger, aNumber } from './random_test_values';
...
interface LocationJSON {
    ...
    readonly phone_numbers?: ReadonlyArray<PhoneNumberJSON> | null;
    readonly addresses?: ReadonlyArray<AddressWithTypeJSON> |  null;
}

interface ServiceAtLocationJSON {
    readonly service?: ServiceJSON | null;
    readonly location?: LocationJSON | null;
}
